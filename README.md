...
|---------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| 1.00    | 14/04/2024 | -Ybañez Esquerre, Miguel Angel <br> - Yen Cerna, Lucio Heli <br> -Barrial Marin, Sharon Antuanet Ivet<br>-Minaya Mondines, Pietro Gerardo<br>-Carpio Cornejo, Miguel Angel <br>-Llacchua Peralta Joseph Ulysses| Se creó la portada y el índice del informe, además se finalizaron todos los aspectos relacionados con el perfil de la solución, el perfil de la startup y la descripción de los antecedentes y problemáticas, así como los segmentos objetivo. Se completaron los capítulos de las pautas generales de estilo, los wireframes, mockups y sus correspondientes flujos de trabajo. También se desarrollaron los diagramas C4. Se completaron las convenciones de trabajo en repositorios y la convenciones de codigo |
...
<img src="./assets/MiguelC_profile.png" alt="Miguel Angel Carpio Cornejo" width="200" height="200">
